...
export const RESEARCHES: Research[] = [
    ...
    { year: 2017, title: 'The Generation of Random Variables Having Mixture Generalized Gamma Distribution by the Acceptance-Rejection Method.', language: 'Thai', publishing: 'Conference Proceedings', downloadLink: 'https://drive.google.com/open?id=0B-PcDocGk261cVYyNUh1dmJVMHc' },
    { year: 2017, title: 'Generating Random Variables for a New Two-parameter Crack Distribution by the Acceptance-Rejection Method.', language: 'Thai', publishing: 'Conference Proceedings', downloadLink: 'https://drive.google.com/open?id=0B-PcDocGk261Q3hnYnAyanJEQkU' },
    { year: 2017, title: 'Point Estimation of Birnbuam-Saunders Distribution Using EM-Algorithm.', language: 'English', publishing: 'Journals', downloadLink: 'https://drive.google.com/open?id=0B-PcDocGk261dFM3N3FOUUE1cGs' },
    { year: 2016, title: 'A Modified Heuristic Algorithm for Total Flow Time Objecctive in Permutation Flow Shops Scheduling.', language: 'Thai', publishing: 'Conference Proceedings', downloadLink: 'https://drive.google.com/open?id=0B-PcDocGk261UHlreTNlMVFidGM' },
